 ...
 * $Revision: 5 $
 * $Date: 20/06/23 7:34p $
 * @brief    M0A21 Series ACMP Driver Header File
 *
 * @note
...
#define ACMP_CTL_POSSEL_DISABLE      (0UL << ACMP_CTL_POSSEL_Pos)  /*!< ACMP_CTL setting for disable all positive input ACMP V+. \hideinitializer */
...
#define ACMP_CTL_POSSEL_CRV          (2UL << ACMP_CTL_POSSEL_Pos)  /*!< ACMP_CTL setting for selecting internal comparator reference voltage CRV as the source of ACMP V+. \hideinitializer */
#define ACMP_CTL_POSSEL_DAC_OUT      (3UL << ACMP_CTL_POSSEL_Pos)  /*!< ACMP_CTL setting for selecting internal DAC Output as the source of ACMP V+. \hideinitializer */

#define ACMP_CTL_NEGSEL_DISABLE      (0UL << ACMP_CTL_NEGSEL_Pos)  /*!< ACMP_CTL setting for disable all negative input ACMP V-. \hideinitializer */
#define ACMP_CTL_NEGSEL_N0           (1UL << ACMP_CTL_NEGSEL_Pos)  /*!< ACMP_CTL setting for selecting ACMPx_N0 pin as the source of ACMP V-. \hideinitializer */
#define ACMP_CTL_NEGSEL_N1           (2UL << ACMP_CTL_NEGSEL_Pos)  /*!< ACMP_CTL setting for selecting ACMPx_N1 pin as the source of ACMP V-. \hideinitializer */
#define ACMP_CTL_NEGSEL_N2           (3UL << ACMP_CTL_NEGSEL_Pos)  /*!< ACMP_CTL setting for selecting ACMPx_N2 pin as the source of ACMP V-. \hideinitializer */
...
/**
  ...
  *                  - \ref ACMP_CTL_POSSEL_DISABLE
  *                  - \ref ACMP_CTL_POSSEL_P0
  *                  - \ref ACMP_CTL_POSSEL_CRV
  *                  - \ref ACMP_CTL_POSSEL_DAC_OUT
  * @return None
...
/**
  ...
  * \hideinitializer
  */
#define ACMP_CRV_SEL(acmp, u32Level) ((acmp)->VREF = ((acmp)->VREF & ~ACMP_VREF_CRVCTL_Msk) | ((u32Level)<<ACMP_VREF_CRVCTL_Pos) | ACMP_VREF_CRVEN_Msk)

...
/*
	...
	DATA FALSH in APROM start address : // 0K
	NOT USE
*/
...
uint8_t check_reset_source(void)
{
    ...
    //TODO: need to check target platform TRM : System Reset Status Register
    SYS->RSTSTS |= 0x1FF;   
...
//    CLK_WaitClockReady(CLK_STATUS_LXTSTB_Msk);	
	...
	// UART 1 for debug
    /* Set PB multi-function pins for UART1 RXD=PB.7 and TXD=PB.5 */
